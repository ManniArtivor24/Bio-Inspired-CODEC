...
def simulate_neural_network(num_steps=120, simulation_duration=50.0, min_current=300.0, max_current=450.0):
    ...
    nest.Connect(neuron_layer2,neuron_layer3,'one_to_one',syn_spec={'weight':1200})
